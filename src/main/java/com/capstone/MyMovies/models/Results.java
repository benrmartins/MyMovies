...
public class Results {
    ...
    public Results(String title, String poster, int budget, String genres, String homepage, String originalLanguage, String overview, int revenue, int runtime, int vote) {
        this.title = title;
        this.poster = poster;
        this.budget = budget;
        this.genres = genres;
